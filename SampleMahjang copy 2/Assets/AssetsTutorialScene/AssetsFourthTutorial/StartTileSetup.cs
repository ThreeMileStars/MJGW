...
public class StartTileSetup : MonoBehaviour {
	...
	public void setupTiles(){
		...
		for(int i=0;i<result.Length;i++)
		{
			...
			tmpGameObject.GetComponent<CubeTileAsset>().onTheBoard=true;
			
			iTween.RotateTo(tmpGameObject,iTween.Hash("y",180f,"x",-15f,"time",0.1f,"looptype",iTween.LoopType.none));
